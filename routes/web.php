...
Route::get('/maintenance_down', function() {
    $exitCode = Artisan::call('down --secret="1630542a-246b-4b66-afa1-dd72a4c43515"');
    return '<h1>Site Down</h1>';
});

Route::get('/maintenance_up', function() {
